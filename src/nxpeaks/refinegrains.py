...
from nxpeaks import transform, indexing, parameters
from nxpeaks import grain, columnfile, closest
...
def lsmo34():
    o=refinegrains()
    o.loadparameters("lsmo34.prm")
    scans  = ["ubfscan_t10000.flt" ]
    for name in scans:
        o.loadfiltered(name)
    o.readubis("lsmo34.ubi")
    o.generate_grains()
    o.tolerance = 0.1
    #o.varytranslations()
